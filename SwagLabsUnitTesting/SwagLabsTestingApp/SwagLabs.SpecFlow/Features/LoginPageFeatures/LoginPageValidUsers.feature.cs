...
#line 1 "LoginPageValidUsers.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/LoginPageFeatures", "Login Tests", "  As a user\r\n  I want to verify that login with different credentials behaves cor" +
                    "rectly\r\n  So that I can ensure the login process works as expected", ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.CategoryAttribute("LoginPageTests")]
...
#line hidden
#line 9
    testRunner.When(string.Format("I attempt to login the user {0} {1} {2}", username, password, isLocked), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
            }
